...
- **Contents**: Tailwind v4 import, dark variant definition, CSS custom properties (background/foreground), custom animations (`shimmer`, `mooving_blob`), utility classes (`skeleton-shimmer-dark`, `skeleton-shimmer`, `mooving_blob`).
...
_Related files: All source files in the project._
