...
.skeleton-shimmer {
  /* zinc gradient, 6s ease-in-out infinite */
}
.skeleton-shimmer-dark {
  /* neutral/zinc dark gradient, 6s ease-in-out infinite */
}
```

**Classes**: `skeleton-shimmer`, `skeleton-shimmer-dark`
...
.mooving_blob {
  animation: mooving_blob 10s infinite;
}
```
...
_Related files: [`app/globals.css`](../app/globals.css), [`lib/utils.ts`](../lib/utils.ts), [`app/page.tsx`](../app/page.tsx)_
