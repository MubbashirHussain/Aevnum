      ...
      <section className="space-y-6">
        <div>
          ...
          <p className="leading-relaxed">
            Welcome to Aevnum. By accessing or utilizing our web-based streaming extraction services 
        ...
        <div>
          ...
          <p className="leading-relaxed">
            Aevnum operates as a high-bandwidth, stateless parser. The platform translates public URL addresses 
        ...
        <div>
          ...
          <p className="leading-relaxed">
            ...
            guarantees of any kind. Aevnum assumes no responsibility for network outages, CDN route alterations, 
